...
# row 3
    ...
    def register_data(self):
        ...
        if self.txt_fname.get() == "" or self.txt_email.get() == "" or self.txt_lname.get() == "" or self.txt_contact.get() == "" or self.cmb_quest.get() == "Select" or self.txt_answer.get() == "" or self.txt_password.get() == "" or self.txt_cpassword.get() == "":
            ...
            try:
                ...
                if row != None:
                    messagebox.showerror(
                        "Error", "User already exists , please add different user", parent=self.root)
                else:
